  ...
  return (
    <div className="-translate-y-10 flex h-screen fixed mt-10 border-r-2 border-app-border bg-app-surface/50">
      <aside className="text-app-text w-64 flex-shrink-0">
        <ul className="py-4">
          <li className="text-lg bg-gradient-to-b from-app-accent to-app-surface rounded-full -translate-x-6">
            <Link
          ...
          <li className="text-lg -translate-x-6 hover:bg-gradient-to-b from-app-accent to-app-surface rounded-full">
